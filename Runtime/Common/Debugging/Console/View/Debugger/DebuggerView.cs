...
using INUlib.Common.Debugging.Console.View.Console;
using INUlib.Common.Debugging.Console.View.Logger;
...
namespace INUlib.Common.Debugging.Console.View.Debugger
{
